...
int main(int argc, char* argv[]) {
    ...
    reconstruire_ppm_depuis_YCbCr(ImgMinorant1ReEchantillonnee, ImgMinorant2ReEchantillonnee, ImgDominante, ImgOut, nTaille); // Il faut ImgY, ImgCb et ImgCr dans cet ordre
