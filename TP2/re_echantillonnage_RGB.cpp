...
int main(int argc, char* argv[]) {
    ...
    lire_nb_lignes_colonnes_image_ppm(nomImageDominante,&nH,&nW);
    ...
    reconstruire_ppm(ImgMinorant1ReEchantillonnee, ImgDominante, ImgMinorant2ReEchantillonnee, ImgOut, nTaille); // Il faut ImgR, ImgG et ImgB dans cet ordre
